export default function HeroSection(){
    ...
    return(
        <>
            <div className=" md:w-3/4 h-screen place-content-center place-self-center elemento-fade">
                <div className="flex flex-row place-self-center mb-8 gap-2">
                    <img src="src/assets/mano_saludando.png" className="h-10 animate-rotate"/>
                ...
                <div className="flex flex-row gap-5 place-self-center mt-4 md:w-155">
                    ...
                    <a className=" bg-[#27062f] border-2 rounded-4xl p-2 flex flex-row gap-2
                        ...
                        <img className="size-6 place-self-center" 
                        src="src/assets/Logos/github_light.svg"/>
                        <label>GitHub</label>
                    </a>
                    <a className=" bg-[#27062f] border-2 rounded-4xl p-2 flex flex-row gap-2
